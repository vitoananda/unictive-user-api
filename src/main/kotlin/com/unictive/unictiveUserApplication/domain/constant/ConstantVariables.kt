package com.unictive.unictiveUserApplication.domain.constant

object ConstantVariables {
    const val SUCCESS_MESSAGE :String= "Berhasil"
    const val DATA_NOT_FOUND: String = "%s tidak ditemukan."
